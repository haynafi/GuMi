...
INSERT INTO `barang` (`id_barang`, `id_kategori`, `nama_barang`, `satuan`, `stok_awal`, `stok_akhir`, `keterangan`, `expired_date`) VALUES
(1, 1, 'Proyektor', 'unit', 10, 7, 'Proyektor untuk presentasi', NULL),
(2, 2, 'Kertas A4', 'rim', 50, 40, 'Kertas untuk cetak', '2025-12-31'),
(3, 3, 'Kompor', 'unit', 5, 5, 'Kompor gas', NULL);
...
(1, 'Sarana Prasarana', '2025-04-27 07:07:52', '2025-04-27 07:07:52'),
(2, 'Barang Habis Pakai', '2025-04-27 07:07:52', '2025-04-27 07:07:52'),
(3, 'Dapur Umum', '2025-04-27 07:07:52', '2025-04-27 07:07:52');
...
(4, '2025_04_24_092105_create_personal_access_tokens_table', 1),
(5, '2025_04_27_065330_create_kategori_table', 1),
(6, '2025_04_27_065343_create_mitra_table', 1),
(7, '2025_04_27_065405_create_transaksi_table', 2);
...
INSERT INTO `mitra` (`id_mitra`, `nama`, `no_hp`, `email`, `alamat`, `perusahaan`, `at`) VALUES
(1, 'Nafi', '08123456789', 'john@example.com', 'Jl. Example No. 1', 'PT Example', '2025-04-01'),
(2, 'Jane Smith', '08198765432', 'jane@example.com', 'Jl. Sample No. 2', 'CV Sample', '2025-04-02');
...
(1, 'Test User', 'test@example.com', NULL, '$2y$12$QE8CMSpqyUAKT0frd6azSu/hUKGiK9H1TgKGh.rMyx0Ewgb0jkg9W', NULL, '2025-04-27 00:08:44', '2025-04-27 00:08:44');
...
ALTER TABLE `transaksi`
  ...
  ADD KEY `transaksi_id_mitra_foreign` (`id_mitra`);
...
ALTER TABLE `transaksi`
  ...
  ADD CONSTRAINT `transaksi_id_mitra_foreign` FOREIGN KEY (`id_mitra`) REFERENCES `mitra` (`id_mitra`) ON DELETE CASCADE;
COMMIT;
